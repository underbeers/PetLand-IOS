...
class OldRegistrationPage2: UIViewController {
    ...
    @IBAction func onSendCodeButtonPress() {
        ...
        interactor?.verifyEmail(email: emailTF.text)
...
extension OldRegistrationPage2: RegistrationPageProtocol {
    func configure(interactor: RegistrationBusinessLogic?) {
        self.interactor = interactor
    }
}

extension OldRegistrationPage2: CustomTextFieldDelegate {
