...
class OldRegistrationPage1: UIViewController {
...
extension OldRegistrationPage1: RegistrationPageProtocol {
    func configure(interactor: RegistrationBusinessLogic?) {
        self.interactor = interactor
    }
}

extension OldRegistrationPage1: CustomTextFieldDelegate {
